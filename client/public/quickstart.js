$(function () {
  ...
  var clientIdentity;
  var baseURL = 'https://emerald.cubefunder.com:850'
  function ConnectPhone(clientName) {

    log('Requesting Capability Token...');
    $.getJSON(`${baseURL}/token?identity=${clientName}`)
      .then(function (data) {
        log('Got a token.');
  ...
  document.getElementById('cs-connect').onclick = function () {

    ConnectPhone('cs');

  }

  document.getElementById('uw-connect').onclick = function () {
